...
// SystemVerilog created from i_iowr_bl_return_zfp_1d_1block_unnamed_zfp_1d_1block19_zfp_1d_1block0
...
module zfp_1d_1block_i_iowr_bl_return_unnamed_z0000ock19_zfp_1d_1block0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_zfp_1d_1block_i_fifoready;
    ...
    assign out_iowr_bl_return_zfp_1d_1block_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_zfp_1d_1block_o_fifovalid = iowr_o_fifovalid;
