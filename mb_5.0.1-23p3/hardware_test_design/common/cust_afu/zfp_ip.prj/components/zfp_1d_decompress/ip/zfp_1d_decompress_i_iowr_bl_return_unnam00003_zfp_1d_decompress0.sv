...
// SystemVerilog created from i_iowr_bl_return_zfp_1d_decompress_unnamed_zfp_1d_decompress23_zfp_1d_decompress0
...
module zfp_1d_decompress_i_iowr_bl_return_unnam00003_zfp_1d_decompress0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_zfp_1d_decompress_i_fifoready;
    ...
    assign out_iowr_bl_return_zfp_1d_decompress_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_zfp_1d_decompress_o_fifovalid = iowr_o_fifovalid;
