...
// SystemVerilog created from i_iowr_bl_return_zfp_inv_lift_unnamed_zfp_inv_lift19_zfp_inv_lift0
...
module zfp_inv_lift_i_iowr_bl_return_unnamed_zf0000lift19_zfp_inv_lift0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_zfp_inv_lift_i_fifoready;
    ...
    assign out_iowr_bl_return_zfp_inv_lift_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_zfp_inv_lift_o_fifovalid = iowr_o_fifovalid;
