...
// SystemVerilog created from i_iord_bl_call_zfp_inv_lift_unnamed_zfp_inv_lift1_zfp_inv_lift0
...
module zfp_inv_lift_i_iord_bl_call_unnamed_zfp_inv_lift1_zfp_inv_lift0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_zfp_inv_lift_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_zfp_inv_lift_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_zfp_inv_lift_i_fifodata),
    ...
    assign out_iord_bl_call_zfp_inv_lift_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iord_bl_call_zfp_inv_lift_o_fifoready = iord_o_fifoready;
