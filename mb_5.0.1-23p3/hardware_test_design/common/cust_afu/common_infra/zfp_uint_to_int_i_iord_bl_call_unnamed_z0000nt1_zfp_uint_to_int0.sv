...
// SystemVerilog created from i_iord_bl_call_zfp_uint_to_int_unnamed_zfp_uint_to_int1_zfp_uint_to_int0
...
module zfp_uint_to_int_i_iord_bl_call_unnamed_z0000nt1_zfp_uint_to_int0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_zfp_uint_to_int_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_zfp_uint_to_int_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_zfp_uint_to_int_i_fifodata),
    ...
    assign out_iord_bl_call_zfp_uint_to_int_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iord_bl_call_zfp_uint_to_int_o_fifoready = iord_o_fifoready;
