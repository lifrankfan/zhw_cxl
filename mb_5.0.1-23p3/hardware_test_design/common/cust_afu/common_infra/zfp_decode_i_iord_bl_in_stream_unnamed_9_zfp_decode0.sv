...
// SystemVerilog created from i_iord_bl_in_stream_unnamed_zfp_decode9_zfp_decode0
...
module zfp_decode_i_iord_bl_in_stream_unnamed_9_zfp_decode0 (
    ...
    // iord(EXTIFACE,4)
    assign iord_i_fifodata = in_iord_bl_in_stream_1_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_in_stream_1_i_fifovalid;
    assign iord_i_predicate = in_c0_exe3218;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_in_stream_1_i_fifodata),
    ...
    assign out_iord_bl_in_stream_1_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,10)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iord_bl_in_stream_1_o_fifoready = iord_o_fifoready;
