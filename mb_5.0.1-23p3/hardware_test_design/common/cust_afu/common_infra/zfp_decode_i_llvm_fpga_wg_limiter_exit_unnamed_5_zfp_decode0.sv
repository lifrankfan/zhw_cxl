...
// SystemVerilog created from i_llvm_fpga_wg_limiter_exit_unnamed_zfp_decode5_zfp_decode0
...
module zfp_decode_i_llvm_fpga_wg_limiter_exit_unnamed_5_zfp_decode0 (
    ...
    zfp_decode_wgl_exit_storage thewgl_exit_storage (
